...
helpers._generateCopayersTestData = function() {
  var xPrivKeys = ['xprv9s21ZrQH143K2n4rV4AtAJFptEmd1tNMKCcSyQBCSuN5eq1dCUhcv6KQJS49joRxu8NNdFxy8yuwTtzCPNYUZvVGC7EPRm2st2cvE7oyTbB',
    ...
    'xprv9s21ZrQH143K48PpVxrh71KdViTFhAaiDSVtNFkmbWNYjwwwPbTrcqoVSafeBfue3Gq9b71hQeEbk67JgtTBcpYgKLF8pTwVnGz56f1BaCYt',
  ...
  _.each(xPrivKeys, function(xPrivKeyStr, c) {
    ...
    var id45 = Model.Copayer._xPubToCopayerId('safe', xpub_45H.toString());
    ...
    var id44btcz = Model.Copayer._xPubToCopayerId('safe', xpub_44H_0H_0H.toString());
...
helpers._parseAmount = function(str) {
  ...
  var re = /^((?:\d+c)|u)?\s*([\d\.]+)\s*(safe|bit|sat)?$/;

 ...
 * @param {string} opts.coin[='safe'] - The coin for this wallet (btc).
 ...
 * @param {string} opts.coin[='safe'] - The expected coin for this wallet (btc).
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['safe', 'bit'], value.toLowerCase());
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='safe'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'safe'] - The coin to estimate fee levels from.
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'safe'] - The coin for this transaction.
